...
public class Cuboid implements Cloneable {
	@Getter final Instance instance;
	@Getter final Point lowerPos;
	@Getter final int lowerX;
	@Getter final int lowerY;
	@Getter final int lowerZ;
	@Getter final Point higherPos;
	@Getter final int higherX;
	@Getter final int higherY;
	@Getter final int higherZ;
	@Getter final List<Point> blocks;
